...
<body>
    ...
    <nav class="navbar navbar-expand-lg custom-navbar">
        <a class="navbar-brand" href="/UAMEmprende/public">
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @unless (Auth::user()->admin)
                                <li><a class="dropdown-item" href="{{ route('profile.edit', Auth::user()->id) }}">Editar
                                        Cuenta</a></li>
                                <li>
                    ...
                    @if (Auth::user()->status)
                        @if (Auth::user()->admin)
                            ...
                            <li class="nav-item">
                                @if (Auth::check() && Auth::user()->admin)
                                    <a class="nav-link" href="{{ route('emprendimientos.pendientes') }}">Solicitudes</a>
                                @endif
                            </li>
                        @else
                            <li class="nav-item">
                    ...
                    @else
                        <li class="nav-item">
                            <span class="nav-link text-warning">Tu cuenta está inhabilitada. Solo puedes ver y calificar
